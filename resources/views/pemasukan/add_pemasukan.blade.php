      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{url('admin/pemasukan/insert_pemasukan')}}" method="post" role="form">
            	{{csrf_field()}}
            	@if ($errors->any())
             ...
             @endif
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputEmail1" name="jumlah_pemasukan" placeholder="Jumlah">
                    </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
              ...
              <div class="card-footer">
              	<a href='{{url("/admin/pemasukan")}}' class="btn btn-default btn_edit">Kembali</a>
