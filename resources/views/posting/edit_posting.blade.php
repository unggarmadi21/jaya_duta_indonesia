      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{url('admin/posting/update_posting', $data->id_posting)}}" method="post" enctype="multipart/form-data" role="form">
              {{csrf_field()}}
              <div class="card-body">
              @if ($errors->any())
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleInputEmail1" name="deskripsi" placeholder="Deskripsi">{{$data->deskripsi}}</textarea>
                    </div>
                </div>
              </div>
              <!-- /.card-body -->
