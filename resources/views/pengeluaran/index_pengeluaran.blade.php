        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{url('admin/pengeluaran/add_pengeluaran')}}" class="btn btn-success form-size-l float-right">Tambah</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-6">
                  <form action="{{url('admin/pengeluaran/export_excel')}}" method="get">
