      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{url('admin/user/update_user',$data->id_user)}}" method="post" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
              <div class="card-body">
              @if ($errors->any())
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="nama_user" value="{{$data->nama_user}}" placeholder="Nama User">
