      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{url('/admin/komunitas/insert_komunitas')}}" method="POST" role="form">
              {{csrf_field()}}
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Komunitas</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="nama_komunitas" placeholder="Nama Komunitas">
                </div>
              </div>
              <!-- /.card-body -->
