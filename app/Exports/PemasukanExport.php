...
class PemasukanExport implements FromView, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('pemasukan.print_pemasukan', [
            'laporan' => Keuangan::where('status', 1)->whereBetween('created_at', [$this->sebelum, $this->sesudah])->get(),
        ]);
    }
